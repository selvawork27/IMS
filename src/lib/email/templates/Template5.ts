...
export function renderTemplate5Email(invoice: InvoiceWithDetails) {
  ...
  <body style=\"margin:0;padding:0;background:#f5f5f5;font-family:Arial,Helvetica,sans-serif;color:#111;\">
    <table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#f5f5f5;padding:24px 0;\">
      <tr><td align=\"center\">
        <table role=\"presentation\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#ffffff;border-radius:4px;overflow:hidden;border:1px solid #e5e7eb;\">
          <tr>
            <td style=\"padding:18px;background:#111;color:#fff;\">
              <table width=\"100%\" role=\"presentation\"><tr>
                <td style=\"font-size:18px;font-weight:800;\">INVOICE</td>
                <td align=\"right\">#${invoice.invoiceNumber}</td>
              </tr></table>
              <div style=\"margin-top:4px;color:#d1d5db;\">${invoice.user.companyName || 'Your Company'}</div>
            </td>
          </tr>
          <tr>
            <td style=\"padding:18px 24px;\">
              <table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\"><tr>
                <td width=\"60%\" valign=\"top\">
                  <div style=\"font-size:11px;color:#6b7280;text-transform:uppercase;\">Billed To</div>
                  <div style=\"font-weight:700;margin-top:6px;\">${invoice.client.name}</div>
                </td>
                <td width=\"40%\" valign=\"top\" align=\"right\">
                  <div style=\"color:#6b7280;\"><strong>Issue:</strong> ${issue}</div>
                  <div style=\"color:#6b7280;margin-top:4px;\"><strong>Due:</strong> ${due}</div>
                </td>
              </tr></table>
              ...
              <div style=\"text-align:center;margin-top:20px;\">
                <a href=\"${process.env.NEXT_PUBLIC_BASE_URL || ''}/invoice/${invoice.id}\" style=\"display:inline-block;background:#111;color:#fff;padding:10px 16px;border-radius:4px;text-decoration:none;\">View Invoice</a>
              </div>
            </td>
          </tr>
        </table>
