...
export function renderTemplate6Email(invoice: InvoiceWithDetails) {
  ...
  <body style=\"margin:0;padding:0;background:#fbf7ff;font-family:Arial,Helvetica,sans-serif;color:#111;\">
    <table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#fbf7ff;padding:24px 0;\">
      <tr><td align=\"center\">
        <table role=\"presentation\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #f1e8ff;\">
          <tr>
            <td style=\"padding:24px;background:#7c3aed;color:#fff;\">
              <table width=\"100%\" role=\"presentation\"><tr>
                <td style=\"font-size:22px;font-weight:900;\">Invoice</td>
                <td align=\"right\">#${invoice.invoiceNumber}</td>
              </tr></table>
              <div style=\"margin-top:6px;color:#ede9fe;\">Issued ${issue} • Due ${due}</div>
            </td>
          </tr>
          <tr>
            <td style=\"padding:20px 24px;\">
              ...
              <div style=\"text-align:center;margin-top:20px;\">
                <a href=\"${process.env.NEXT_PUBLIC_BASE_URL || ''}/invoice/${invoice.id}\" style=\"display:inline-block;background:#7c3aed;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;\">View Invoice</a>
              </div>
            </td>
          </tr>
        </table>
