...
export function renderTemplate4Email(invoice: InvoiceWithDetails) {
  ...
  <body style=\"margin:0;padding:0;background:#f6f8ff;font-family:Arial,Helvetica,sans-serif;color:#111;\">
    <table role=\"presentation\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#f6f8ff;padding:24px 0;\">
      <tr><td align=\"center\">
        <table role=\"presentation\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\" style=\"background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 6px 16px rgba(35,136,255,0.1);\">
          <tr>
            <td style=\"padding:24px;border-bottom:3px solid #2388ff;\">
              <table width=\"100%\" role=\"presentation\"><tr>
                <td style=\"font-size:24px;font-weight:900;color:#2388ff;\">${invoice.user.companyName || 'Your Company'}</td>
                <td align=\"right\" style=\"color:#6b7280;\">Invoice <strong>#${invoice.invoiceNumber}</strong></td>
              </tr></table>
              <div style=\"margin-top:6px;color:#6b7280;\">Issued ${issue} • Due ${due}</div>
            </td>
          </tr>
          <tr>
            <td style=\"padding:20px 24px;\">
              ...
              <div style=\"text-align:center;margin-top:20px;\">
                <a href=\"${process.env.NEXT_PUBLIC_BASE_URL || ''}/invoice/${invoice.id}\" style=\"display:inline-block;background:#2388ff;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;\">View Invoice</a>
              </div>
            </td>
          </tr>
        </table>
