...
CREATE TABLE `users` (
  ...
  KEY `users_client_id_fkey` (`client_id`),
...
INSERT INTO `users` VALUES ('1','admin','admin@gmail.com',NULL,NULL,'$2b$10$2vd6Q9Rl.LQ1s/okCMgS4.0jK0s6mznh0Z3WuHrzG/5SQcN3LbCC2','2026-01-13 12:49:37.000','2026-01-13 08:03:37.717','UTC','USD','en','MM/DD/YYYY','FREE',NULL,NULL,'DevEnv Tech','info@devenv.tech','+91 7259960517','Workflow, Ranka Group, Tin Factory, Near Bennigahalli, Bangalore. 560016','https://devenv.tech/',NULL,0.0000,NULL,1,1,0,NULL);
